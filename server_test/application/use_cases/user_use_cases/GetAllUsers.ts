...
export class GetAllUsers implements UseCaseInterface{
    ...
    async executeGetAndDeleteUseCases(): Promise<any> {
        try {
            //Check if user is existed
            const users:UserInterface[] = await this.userRepository.getAllUsers();
